[ DataRobot docs ](../../index.html "DataRobot docs")
  ...
  * [ AI Apps ](../index.html) [ AI Apps ](../index.html)
    ...
    * [ Custom apps ](index.html) [ Custom apps ](index.html)
      * [ Upload custom applications ](app-upload-custom.html)
      * [ Host custom applications ](custom-apps-hosting.html)
      * [ Manage custom applications ](manage-custom-apps.html)
...
[AI Apps](../index.html "AI Apps") > Custom apps

# Custom apps¶

The following sections describe the documentation available for custom AI
Apps:

Topic | Description  
---|---  
[Host custom applications](custom-apps-hosting.html) | Host a custom application, such as a Streamlit app, in DataRobot using a DataRobot execution environment.  
[Custom applications upload](app-upload-custom.html) | Create custom AI Apps in DataRobot to share machine learning projects using web applications like Streamlit and Dash.  
[Manage custom applications](manage-custom-apps.html) | Share, stop, or delete custom applications.  
