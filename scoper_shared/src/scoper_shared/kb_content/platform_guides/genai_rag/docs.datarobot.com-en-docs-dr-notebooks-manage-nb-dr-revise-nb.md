[ DataRobot docs ](../../index.html "DataRobot docs")
  ...
  * [ Notebooks ](../index.html) [ Notebooks ](../index.html)
    * [ Manage notebooks ](index.html) [ Manage notebooks ](index.html)
      * [ Add notebooks ](dr-create-nb.html)
      * [ Notebook settings ](dr-settings-nb.html)
      * [ Notebook versioning ](dr-revise-nb.html) [ Notebook versioning ](dr-revise-nb.html)
...
Notebook versioning
    ...
    * [ Notebook coding experience ](../code-nb/index.html) [ Notebook coding experience ](../code-nb/index.html)
      * [ Environment management ](../code-nb/dr-env-nb.html)
      * [ Create and execute cells ](../code-nb/dr-cell-nb.html)
      * [ Cell actions ](../code-nb/dr-action-nb.html)
      * [ Code intelligence ](../code-nb/dr-code-int.html)
      * [ Notebook terminals ](../code-nb/dr-terminal-nb.html)
      * [ Azure OpenAI Service integration ](../code-nb/dr-openai-nb.html)
...
[Notebooks](../index.html "Notebooks") > [Manage notebooks](index.html "Manage
notebooks") > Notebook versioning

# Notebook versioning¶

You can snapshot iterations of a notebook, allowing you to maintain older
versions that you can revert back to in the future. These snapshots are called
revisions (also known as checkpoints). Each saved revision contains the
notebook's cells and their output in their state at the time of the snapshot.

### Revision types¶

DataRobot Notebooks support both automatic and manual revisions.

_Automatic revisions_ are saved each time a notebook’s active session is shut
down (from either your own termination of the session or via an inactivity
timeout). Automatic revisions are defined by the creation timestamp and
include an "Autosaved" label.

[![](../../images/nb-29.png)](../../images/nb-29.png)

You can create a _manual revision_ at any time to save a checkpoint of a
notebook. To do so, navigate to the **Revision history** tab in the sidebar.

[![](../../images/nb-19.png)](../../images/nb-19.png)

Click **Create new revision**. Provide a name for the revision in the a dialog
box. If no name is specified, the timestamp of the checkpoint creation is
used. Once named, click **Create**.

[![](../../images/nb-20.png)](../../images/nb-20.png)

### Revision history¶

View a list of all revisions (manual and automatic) for a notebook from the
**Revision history** in the left panel. Click on the revision entry to view a
preview of that version of the notebook:

[![](../../images/nb-21.png)](../../images/nb-21.png)

You can restore your current notebook to a specific revision by clicking
**Restore this revision** at the bottom of the preview.

Access additional actions for managing revisions by clicking the menu icon on
the right of each entry. Note that you can update the names of manual
revisions, while autosaved revisions will only have their timestamp as a name.

[![](../../images/nb-22.png)](../../images/nb-22.png)
