[ DataRobot docs ](../../index.html "DataRobot docs")
  ...
  * [ AI Apps ](../index.html) [ AI Apps ](../index.html)
    ...
    * [ Use no-code applications ](index.html) [ Use no-code applications ](index.html)
      * [ Make predictions ](app-make-pred.html)
      * [ View prediction results ](app-analyze-result.html)
...
[AI Apps](../index.html "AI Apps") > Use no-code applications

# Use no-code applications¶

On the **Applications** tab, click **Open** next to the application you want
to launch—from here you can test different application configurations before
sharing it with users.

Note

End-users must sign in with a DataRobot account or access the application via
a [link that can be shared with users](../edit-apps/app-
settings.html#permissions) outside of DataRobot.

These sections describe the actions available when using No-Code AI Apps:

Topic | Description  
---|---  
[Make predictions](app-make-pred.html) | Make single record or batch predictions.  
[Analyze prediction results](app-analyze-result.html) | Analyze prediction information and insights for individual predictions.  
  
## UI overview¶

[![](../../images/use-app-1.png)](../../images/use-app-1.png)
...
4 | [Share](../current-app.html#share-applications) | Shares the application with users, groups, or organizations within DataRobot.  
