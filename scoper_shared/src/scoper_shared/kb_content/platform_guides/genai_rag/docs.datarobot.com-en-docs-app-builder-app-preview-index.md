...
Preview (off)
  ...
  * [ AI Apps ](../index.html) [ AI Apps ](../index.html)
    ...
    * [ AI App preview features ](index.html) [ AI App preview features ](index.html)
      * [ Prefill application templates ](app-prefill.html)
...
[AI Apps](../index.html "AI Apps") > AI App preview features
...
Feature | Description  
---|---  
[Prefilled app templates](app-prefill.html) | Prefill applications upon creation to more easily visualize the end-user experience.  
[Feature Discovery support in No-Code AI Apps](app-ft-cache.html) | Create No-Code AI Apps from Feature Discovery projects.  
