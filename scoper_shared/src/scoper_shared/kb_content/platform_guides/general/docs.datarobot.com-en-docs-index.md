...
Find all the information you need to succeed with DataRobot, in a style that
suits you best.

  * #### [Get Started](get-started/index.html)¶

Analyze data, create models, and write code

  * #### [Generative AI](gen-ai/index.html)¶

Create vector databases and LLM blueprints and prepare for deployment

  * #### [Agentic AI](agentic-ai/index.html)¶

Connect and test agentic workflows, integrate tools, and implement evaluation
metrics

  * #### [NextGen UI](workbench/index.html)¶

Docs for NextGen UI-based DataRobot use

  * #### [Classic UI](classic-ui.html)¶

Docs for classic UI-based DataRobot use

  * #### [Developer docs](api/index.html)¶

Docs for code-first DataRobot use

  * #### [Account management](platform/index.html)¶

Get help managing the DataRobot application

  * #### [Releases](release/index.html)¶

Managed AI Cloud and on-prem release information

  * #### [Reference](reference/index.html)¶

Access reference content for DataRobot predictive and generative modeling
