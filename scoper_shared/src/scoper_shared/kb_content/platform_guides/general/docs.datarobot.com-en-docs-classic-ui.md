...
Learn every aspect of the classic DataRobot workflow, from importing data to
deploying and managing models.

  * #### [Data](data/index.html)¶

Ingest, transform, and store your data for modeling.

  * #### [Modeling](modeling/index.html)¶

Build, compare, and manage models.

  * #### [Predictions](predictions/index.html)¶

Make predictions with the UI or API.

  * #### [MLOps](mlops/index.html)¶

Deploy, monitor, manage, and govern models in production.

  * #### [DataRobot Notebooks](dr-notebooks/index.html)¶

Create interactive and executable computing documents.

  * #### [Applications](app-builder/index.html)¶
