[ DataRobot docs ](../../index.html "DataRobot docs")
  ...
  * [ Integrations ](../index.html) [ Integrations ](../index.html)
    ...
    * [ Snowflake ](index.html) [ Snowflake ](index.html)
      ...
      * [ Real-time predictions ](sf-client-scoring.html)
...
[Integrations](../index.html "Integrations") > Snowflake

# Snowflake¶

The articles in this section progress from data ingest to creating projects
and machine learning models based on historic training sets, and finally to
scoring new data through deployed models via several deployment methodologies:

Topic | Description  
---|---  
[Data ingest](sf-project-creation.html) | Retrieving data for Snowflake project creation.  
[Wrangle Snowflake data in DataRobot](../../workbench/wb-dataprep/wb-wrangle-data/build-recipe/index.html) | Using Workbench in DataRobot, build wrangling recipes and push down those transformations to Snowflake where they are applied to the source data by leveraging Snowflake SQL.  
[Real-time predictions](sf-client-scoring.html) | Using the API to score Snowflake data.  
[Server-side model scoring](sf-server-scoring.html) | Using the API to integrate your deployment with Snowflake to feed data to your model for predictions and to write those predictions back to your Snowflake Database.  
[External functions and streams](sf-function-streams.html) | Using external API call functions to create a Snowflake scoring pipeline.  
[Generate Snowflake UDF Scoring Code](snowflake-sc.html) | Using the DataRobot Scoring Code JAR as a user-defined function (UDF) on Snowflake.  
