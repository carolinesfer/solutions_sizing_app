  ...
  * [ Integrations ](../../index.html) [ Integrations ](../../index.html)
    * [ AWS ](../index.html) [ AWS ](../index.html)
      ...
      * [ AWS Lambda ](index.html) [ AWS Lambda ](index.html)
        ...
        * [ Use Scoring Code with AWS Lambda ](sc-lambda.html)
...
The sections described below provide techniques for integrating AWS Lambda
with DataRobot.

Topic | Description  
---|---  
[AWS Lambda reporting to MLOps](aws-lambda-reporting-to-mlops.html) | AWS Lambda serverless reporting of actuals to DataRobot MLOps.  
[Use DataRobot Prime models with AWS Lambda](prime-lambda.html) | Using DataRobot Prime* models with AWS Lambda.  
[Use Scoring Code with AWS Lambda](sc-lambda.html) | Making predictions using Scoring Code deployed on AWS Lambda.  
