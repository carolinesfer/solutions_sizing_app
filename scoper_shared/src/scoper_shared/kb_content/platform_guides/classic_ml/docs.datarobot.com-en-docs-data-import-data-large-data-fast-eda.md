[ DataRobot docs ](../../../index.html "DataRobot docs")
  ...
  * [ Data ](../../index.html) [ Data ](../../index.html)
    * [ Data connections ](../../connect-data/index.html) [ Data connections ](../../connect-data/index.html)
      * [ Share secure configurations ](../../connect-data/secure-config.html)
      * [ Data connections ](../../connect-data/data-conn.html)
    * [ AI Catalog ](../../ai-catalog/index.html) [ AI Catalog ](../../ai-catalog/index.html)
      * [ Load data ](../../ai-catalog/catalog.html)
      * [ Manage assets ](../../ai-catalog/manage-asset.html)
      * [ Work with assets ](../../ai-catalog/catalog-asset.html)
      * [ Schedule snapshots ](../../ai-catalog/snapshot.html)
      * [ Prepare data with Spark SQL ](../../ai-catalog/spark.html)
    * [ Import data ](../index.html) [ Import data ](../index.html)
      * [ Import to DataRobot directly ](../import-to-dr.html)
      * [ Large datasets ](index.html) [ Large datasets ](index.html)
        * [ Fast EDA for large datasets ](fast-eda.html) [ Fast EDA for large datasets ](fast-eda.html)
...
Fast EDA for large datasets
    ...
    * [ Transform data ](../../transform-data/index.html) [ Transform data ](../../transform-data/index.html)
      * [ Interaction-based transformations ](../../transform-data/feature-disc.html)
      * [ Feature Discovery ](../../transform-data/feature-discovery/index.html) [ Feature Discovery ](../../transform-data/feature-discovery/index.html)
        * [ End-to-end Feature Discovery ](../../transform-data/feature-discovery/enrich-data-using-feature-discovery.html)
        * [ Set up Feature Discovery projects ](../../transform-data/feature-discovery/fd-overview.html)
        * [ Snowflake integration ](../../transform-data/feature-discovery/fd-snowflake.html)
        * [ Feature Discovery settings ](../../transform-data/feature-discovery/fd-adv-opt.html)
        * [ Time-aware feature engineering ](../../transform-data/feature-discovery/fd-time.html)
        * [ Derived features ](../../transform-data/feature-discovery/fd-gen.html)
        * [ Predictions ](../../transform-data/feature-discovery/fd-predict.html)
      * [ Manual transformations ](../../transform-data/feature-transforms.html)
    * [ Analyze data ](../../analyze-data/index.html) [ Analyze data ](../../analyze-data/index.html)
      * [ Assess data quality with EDA ](../../analyze-data/assess-data-quality-eda.html)
      * [ Analyze features using histograms ](../../analyze-data/analyze-histogram.html)
      * [ Analyze frequent values ](../../analyze-data/analyze-frequent-values.html)
      * [ Feature details ](../../analyze-data/histogram.html)
      * [ Exploratory Spatial Data Analysis (ESDA) ](../../analyze-data/lai-esda.html)
      * [ Feature Associations ](../../analyze-data/feature-assoc.html)
      * [ Use data pipelines for ingest and transformation ](../../analyze-data/pipelines.html)
    * [ Data preview features ](../../data-preview/index.html) [ Data preview features ](../../data-preview/index.html)
      * [ Create feature lists in the Relationship Editor ](../../data-preview/safer-rel-editor-feature-lists.html)
    * [ Data FAQ ](../../data-faq.html)
...
[Data](../../index.html "Data") > [Import data](../index.html "Import data") >
[Large datasets](index.html "Large datasets") > Fast EDA for large datasets

# Early target selection¶

The data ingestion process for large datasets can, optionally, be different
than that used for smaller sets. (You can also use the _same_ process by
letting the project complete [EDA1](../../../reference/data-ref/eda-
explained.html#eda1).) When DataRobot optimizes for larger sets, it launches
"Fast (or preliminary) EDA," a subset of the full EDA1 process, which looks
more like:
...
When working with large datasets, you cannot create GLM, ENET, or PLS [blender
models](../../../modeling/build-models/build-basic/creating-addl-
models.html#create-a-blended-model). Median and average blenders _are_
available. Also, Fast EDA is disabled in some cases, such as when the dataset
has too many columns or uses too much RAM during ingest.

## Fast EDA application¶

A dataset qualifies for Fast EDA if it is larger than 5MB, has fewer than
10,000 columns, and if when you begin to load data, 10 seconds elapse and the
ingestion process is less than 75% complete. Note that the ingestion process
is internal to DataRobot and may appear differently to you in the status bar.
Fast EDA allows you to see preliminary EDA1 results and explore your data
shortly after upload begins and while ingestion continues. Once Fast EDA
completes, DataRobot continues calculating until full EDA1 completes.
...
Fast EDA is calculated on the first _X_ rows of the dataset, not a random
sample.

## Fast EDA and early target selection¶

Fast EDA paves the way for early target selection. Once you have chosen the
target, DataRobot populates the project options (partitioning, downsampling,
number of workers, etc.) with default values based on your Fast EDA data. You
can change and save the options, then set the project to auto-start at the
completion of full EDA1. In this way, you do not have to check repeatedly for
ingestion completion, which can be time consuming with quite large datasets.
If there is any kind of error in the settings or ingest, DataRobot notifies
you by email with an informative error message (if configured to do so). Once
you set the target and any advanced options, even if you close your browser,
DataRobot saves your project selections.

You can set the following at the completion of Fast EDA:

  * [Target](../../../modeling/build-models/build-basic/model-data.html#set-the-target-feature)
  * [Metric](../../../modeling/build-models/adv-opt/additional.html#change-the-optimization-metric)
  * [Initial number of workers](../../../reference/pred-ai-ref/worker-queue.html)
  * [Modeling mode](../../../modeling/build-models/build-basic/model-data.html#set-the-modeling-mode)
  * [Advanced options](../../../modeling/build-models/adv-opt/index.html)
    * [Smart Downsampling](../../../modeling/build-models/adv-opt/smart-ds.html)
    * [Partitioning Method](../../../modeling/build-models/adv-opt/partitioning.html)
    * [Additional Parameters](../../../modeling/build-models/adv-opt/additional.html)

Until full EDA1 completes, you cannot:

  * View [feature importance](../../../reference/pred-ai-ref/model-ref.html#data-summary-information)
  * Create [feature lists](../../../modeling/build-models/build-basic/feature-lists.html#create-feature-lists)
  * Perform [feature transformations](../../../modeling/build-models/build-basic/model-data.html#create-new-features)

## Apply early target selection¶

To use early target selection, keep an eye on the **Start** screen and the
processing status reported in the right sidebar. Fast EDA is part of the
ingestion process, but if your dataset is too small for early target selection
to make sense, you won't be able to modify these selections and EDA1 will go
on to complete. If early target selection is applicable to your project, you
will see a change in the start screen that indicates early target selection is
an option:

[![](../../../images/early-target-shadow.png)](../../../images/early-target-
shadow.png)

To use early target selection:

  1. [Import your dataset](../import-to-dr.html) to DataRobot.
...
[![](../../../images/early-target-2.png)](../../../images/early-target-2.png)
...
[![](../../../images/early-target-3.png)](../../../images/early-target-3.png)

  4. Click the [**Show Advanced options**](../../../modeling/build-models/adv-opt/index.html) link to set additional parameters.

  5. If you choose to auto-start the model build process, toggle the auto-start and [select a modeling mode](../../../modeling/build-models/build-basic/model-data.html#set-the-modeling-mode):

[![](../../../images/early-target-4.png)](../../../images/early-target-4.png)

When full EDA1 completes, DataRobot launches the model building process using
the criteria you set.

## More info...¶

When working with large datasets, there are some differences in behaviors that
you should note.

### Train into validation and holdout¶

If, when training models, you trained into the validation and/or holdout sets,
those scores display `N/A` on the Leaderboard:

[![](../../../images/early-target-na.png)](../../../images/early-target-
na.png)

With large datasets, DataRobot disables internal cross-validation when you
train models into validation/holdout. For anything over 800MB, DataRobot uses
[TVH](../../../reference/pred-ai-ref/data-partitioning.html#training-
validation-and-holdout-tvh) as the default validation method. This is because
the validation/holdout rows are used for training the model, the scores are
not likely to be an accurate representation of the model performance on unseen
data (and thus, `N/A`).
...
You can change model sample size either from the
[Leaderboard](../../../modeling/build-models/build-basic/creating-addl-
models.html#use-add-new-model) or the
[**Repository**](../../../modeling/build-models/build-
basic/repository.html#create-a-new-model). Additionally, you cannot change the
sample size for blender models. If you do wish to change a blender sample
size, you can:

  1. Retrain each constituent model at the new sample size.
  2. Blend the constituent models to [make a new blender](../../../modeling/build-models/build-basic/creating-addl-models.html#create-a-blended-model).

### Understand the messages¶

DataRobot provides some notifications to help you interpret the preliminary
data displayed and used for early target selection. For example:

The [Smart Downsampling](../../../modeling/build-models/adv-opt/smart-ds.html)
setting is available (for binary classification or zero-boosted regression
problems) after you set your target. The notification about the feature
indicates the subset of data, in number of rows, that DataRobot will use in
modeling. You can change the value in **Advanced options** :

[![](../../../images/early-target-6.png)](../../../images/early-target-6.png)

The dataset notification tells you the number of rows in your dataset that are
missing the target variable (and are therefore excluded from model
building/predictions):

[![](../../../images/early-target-7.png)](../../../images/early-target-7.png)

Additionally, auto-start returns a partitioning error when DataRobot bases
preliminary calculations for partitioning settings on a subset of your
dataset. If the cardinality of your partitioning column is outside the given
range, auto-start returns an error.
