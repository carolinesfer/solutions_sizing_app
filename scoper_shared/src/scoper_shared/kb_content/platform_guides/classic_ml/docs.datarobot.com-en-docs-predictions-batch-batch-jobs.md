[ DataRobot docs ](../../index.html "DataRobot docs")
  ...
  * [ Predictions ](../index.html) [ Predictions ](../index.html)
    ...
    * [ Batch prediction methods ](index.html) [ Batch prediction methods ](index.html)
      * [ Batch prediction UI ](batch-dep/index.html) [ Batch prediction UI ](batch-dep/index.html)
        * [ Make a one-time batch prediction ](batch-dep/batch-pred.html)
        * [ Schedule recurring batch prediction jobs ](batch-dep/batch-pred-jobs.html)
        * [ Manage prediction job definitions ](batch-dep/manage-pred-job-def.html)
        * [ Snowflake prediction job examples ](batch-dep/pred-job-examples-snowflake.html)
      ...
      * [ Manage batch jobs ](batch-jobs.html) [ Manage batch jobs ](batch-jobs.html)
...
methods](index.html "Batch prediction methods") > Manage batch jobs

# Manage batch jobs¶

To access batch jobs, navigate to **Deployments > Batch Jobs**. You can view
and manage all running or complete jobs. Any prediction or monitoring jobs
created for deployments appear on this page. In addition, you can filter jobs
by status, type, start and end time, deployment, job definition ID, job ID,
and prediction environment.

[![](../../images/prediction-jobs.png)](../../images/prediction-jobs.png)

Shared batch jobs

For information on the role-based access controls for shared batch jobs, see
the [Roles and permissions](../../reference/misc-ref/roles-
permissions.html#shared-deployment-job-roles) documentation.

## View batch jobs¶

The following table describes the information displayed in the **Batch Jobs**
list.
...
Status | [State](../../api/reference/batch-prediction-api/index.html#job-states) of the job.  
Source | [Intake adapter](../../api/reference/batch-prediction-api/intake-options.html) for this prediction job.  
Destination | [Output adapter](../../api/reference/batch-prediction-api/output-options.html) for the prediction job.  
  
## Manage batch jobs¶

To manage a job, select from the action menu on the right:

[![](../../images/prediction-jobs-action-menu.png)](../../images/prediction-
jobs-action-menu.png)
...
[![](../../images/prediction-jobs-select-filter.png)](../../images/prediction-
jobs-select-filter.png)

  2. Set filters and click **Apply filters**. Click **Clear filters** to reset the fields. 

[![](../../images/prediction-jobs-filter.png)](../../images/prediction-jobs-
filter.png)

| Element | Description  
---|---|---  
1 | Status | Select job status types to filter by: **Queued** , **Running** , **Succeeded** , **Aborted** , and **Failed**.  
2 | Batch job type | Select job type to filter by:
     * **Batch prediction job**
     * **Monitoring job**  
3 | Job source | Select job source type to filter by:
     * Batch prediction jobs (**Schedule Run** , **Manual Run**)
     * Integration jobs (**Integration**)
     * [Batch predictions generated from the UI](batch-dep/batch-pred.html) (**Make Predictions**)
     * [Batch Prediction API](../../api/reference/batch-prediction-api/index.html) jobs (**Ad hoc API**)
     * Insight jobs (**Insights**)
     * [Portable Prediction Server](../port-pred/pps/portable-pps.html) jobs (**Portable**)
     * [Challenger](../../mlops/monitor/challengers.html) jobs (**Challenger**)  
4 | Added to queue | Filter by a time range: **Before** or **After** a date you select.  
5 | Deployment | Select a deployment to filter by. Start typing and select a deployment from the dropdown list.  
6 | Job Definition ID | Filter by the jobs generated from a specific job definition. Start typing and select a job definition ID from the dropdown list.  
7 | Prediction Job ID | Enter a specific prediction job ID.  
8 | Prediction Environment | Select from your configured [prediction environments](../../mlops/deployment/ext-model-prep/ext-pred-env.html).  
