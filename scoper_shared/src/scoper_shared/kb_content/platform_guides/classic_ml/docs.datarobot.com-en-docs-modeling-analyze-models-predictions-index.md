[ DataRobot docs ](../../../index.html "DataRobot docs")
  ...
  * [ Modeling ](../../index.html) [ Modeling ](../../index.html)
    ...
    * [ Model insights ](../index.html) [ Model insights ](../index.html)
      ...
      * [ Predict ](index.html) [ Predict ](index.html)
        * [ Deploy ](deploy.html)
        * [ Downloads ](download.html)
        * [ Make Predictions ](predict.html)
        * [ Portable Predictions ](port-pred.html)
...
"Model insights") > Predict

# Predict¶

The **Predict** tab allows you to download various model assets and test
predictions. For more information about the predictions methods in DataRobot,
see [Predictions Overview](../../../predictions/index.html).

The following sections describe the components of the **Predict** tab.

Tab | Description  
---|---  
[Deploy](deploy.html) | Deploy a model from the Leaderboard to make predictions in a production environment.  
[Downloads](download.html) | Download artifacts, such as model packages and a ZIP archive of model information.  
[Make Predictions](predict.html) | Use the model to test predictions on up to 1GB of data before deploying it.  
[Portable Predictions](port-pred.html) | Execute predictions outside of the DataRobot application using [Scoring Code](../../../predictions/port-pred/scoring-code/index.html) or the [Portable Prediction Server](../../../predictions/port-pred/pps/index.html).  
