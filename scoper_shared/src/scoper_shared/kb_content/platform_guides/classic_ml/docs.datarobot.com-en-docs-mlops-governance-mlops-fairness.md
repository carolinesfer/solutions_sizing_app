[ DataRobot docs ](../../index.html "DataRobot docs")
  ...
  * [ MLOps ](../index.html) [ MLOps ](../index.html)
    ...
    * [ Governance ](index.html) [ Governance ](index.html)
      ...
      * [ Notifications tab ](deploy-notifications.html)
      * [ Humility tab ](humble.html)
      * [ Fairness tab ](mlops-fairness.html) [ Fairness tab ](mlops-fairness.html)
...
The **Fairness** tab is only available for DataRobot MLOps users. Contact your
DataRobot representative for more information about enabling this feature.

After you configure a deployment's [fairness settings](../deployment-
settings/fairness-settings.html), you can use the **Fairness** tab to
configure tests that allow models to monitor and recognize, in real time, when
protected features in the dataset fail to meet predefined fairness conditions.
When viewing the **Deployment** inventory with the [**Governance** lens](gov-
lens.html), the **Fairness** column provides an at-a-glance indication of how
each deployment is performing based on the fairness tests set up in the
**Settings > Data** tab.

[![](../../images/bf-mlops-9.png)](../../images/bf-mlops-9.png)

To view more detailed information for an individual model or investigate why a
model is failing fairness tests, click on a deployment in the inventory list
and navigate to the **Fairness** tab.

Note

To receive email notifications on fairness status, [configure
notifications](deploy-notifications.html), [schedule
monitoring](../deployment-settings/fairness-settings.html#schedule-fairness-
monitoring-notifications), and [configure fairness monitoring
settings](../deployment-settings/fairness-settings.html).

## Investigate bias¶

The **Fairness** tab helps you understand why a deployment is failing fairness
tests and which protected features are below the predefined fairness
threshold. It provides two interactive and exportable visualizations that help
identify which feature is failing fairness testing and why.

[![](../../images/bf-mlops-2.png)](../../images/bf-mlops-2.png)
...
If a feature is marked as _below threshold_ , the feature does not meet the
predefined fairness conditions.

Select the feature on the left to display fairness scores for each segmented
attribute and better understand where bias exists within the feature.

[![](../../images/bf-mlops-3.png)](../../images/bf-mlops-3.png)

To further modify the display, see the documentation for the [version
selector](../monitor/data-drift.html).

### View per-class bias¶

The **Per-Class Bias** chart helps to identify if a model is biased, and if
so, how much and who it's biased towards or against. For more information, see
the existing documentation on [per-class bias](../../modeling/analyze-
models/bias/per-class.html).

[![](../../images/bf-mlops-4.png)](../../images/bf-mlops-4.png)

Hover over a point on the chart to view its details:

[![](../../images/bf-mlops-5.png)](../../images/bf-mlops-5.png)

### View fairness over time¶

After configuring fairness criteria and making predictions with fairness
monitoring enabled, you can view how [fairness scores](../../reference/pred-
ai-ref/bias-ref.html) of the protected feature or feature values have changed
over time for a deployment. The X-axis measures the range of time that
predictions have been made for the deployment, and the Y-axis measures the
fairness score.

[![](../../images/bf-mlops-6.png)](../../images/bf-mlops-6.png)

Hover over a point on the chart to view its details:

[![](../../images/bf-mlops-7.png)](../../images/bf-mlops-7.png)

You can also hide specific features or feature values from the chart by
unchecking the box next to its name:

[![](../../images/bf-mlops-8.png)](../../images/bf-mlops-8.png)

The controls work the same as those available on the [Data
Drift](../monitor/data-drift.html) tab.
