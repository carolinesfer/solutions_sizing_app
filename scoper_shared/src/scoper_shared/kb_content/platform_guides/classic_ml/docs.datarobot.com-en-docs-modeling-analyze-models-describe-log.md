  ...
  * [ Modeling ](../../index.html) [ Modeling ](../../index.html)
    ...
    * [ Model insights ](../index.html) [ Model insights ](../index.html)
      ...
      * [ Describe ](index.html) [ Describe ](index.html)
        ...
        * [ Blueprint JSON ](blueprint-json.html)
        * [ Coefficients (preprocessing) ](coefficients.html)
        * [ Constraints (monotonic) ](monotonic.html)
        * [ Data Quality Handling Report ](dq-report.html)
        * [ Eureqa Models ](eureqa.html)
        * [ Log ](log.html)
        * [ Model Info ](model-info.html)
        * [ Rating Tables ](rating-table.html)
        * [ GA2M output (from Rating Tables) ](ga2m.html)
...
"Model insights") > [Describe](index.html "Describe") > Log

# Log¶

The model log displays the status of successful (green INFO tags) and errored
(red ERROR tags) individual tasks that make up a modeling job. To display the
model log, click a model on the Leaderboard list, then click **Log**.

Note

If you receive text-based insight model errors, see this
[note](../other/analyze-insights.html#text-based-insights) for a description
of how DataRobot handles single-character "words."

The following example shows a simple (and fast) blueprint consisting of two
tasks being trained—Missing Values Imputation and Decision Tree:

[![](../../../images/rn-model-info-enhance.png)](../../../images/rn-model-
info-enhance.png)
...
The second part shows the calculation of _validation_ metrics and insights:
...
In the image above, you can see that the last two tasks were executed for
holdout as well.
