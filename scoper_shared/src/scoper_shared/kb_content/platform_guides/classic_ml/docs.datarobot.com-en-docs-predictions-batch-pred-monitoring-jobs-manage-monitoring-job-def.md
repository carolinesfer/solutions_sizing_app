[ DataRobot docs ](../../../index.html "DataRobot docs")
  ...
  * [ Predictions ](../../index.html) [ Predictions ](../../index.html)
    ...
    * [ Batch prediction methods ](../index.html) [ Batch prediction methods ](../index.html)
      ...
      * [ Prediction monitoring jobs ](index.html) [ Prediction monitoring jobs ](index.html)
        * [ Create monitoring jobs ](ui-monitoring-jobs.html)
        * [ Monitoring jobs API ](api-monitoring-jobs.html)
        * [ Manage monitoring job definitions ](manage-monitoring-job-def.html) [ Manage monitoring job definitions ](manage-monitoring-job-def.html)
...
methods](../index.html "Batch prediction methods") > [Prediction monitoring
jobs](index.html "Prediction monitoring jobs") > Manage monitoring job
definitions

# Manage monitoring job definitions¶

To view and manage monitoring job definitions, select a deployment on the
**Deployments** tab and navigate to the **Job Definitions > Monitoring Jobs**
tab.

[![](../../../images/batch-pred-job-def-list.png)](../../../images/batch-pred-
job-def-list.png)

Click the action menu for a job definition and select one of the actions
described below:
...
Shared job definitions appear alongside your own; however, if you don't have
access to the prediction **Source** in the AI Catalog, the dataset ID is
**[redacted]**.

[![](../../../images/batch-pred-job-def-rbac.png)](../../../images/batch-pred-
job-def-rbac.png)

With the correct permissions, you can perform the job definition actions
defined above. For information on which actions are available for each
deployment [role](../../../reference/misc-ref/roles-permissions.html#role-
definitions), see the [Roles and permissions](../../../reference/misc-
ref/roles-permissions.html#shared-deployment-job-roles) documentation.

If you have _Owner_ permissions, you can click **Edit definition** to edit the
shared job definition. To edit the source settings, if the **Source type**
relies on credentials or the AI Catalog dataset isn't shared with you, you
must click **Reset connection** and configure a new **Source type** :

[![](../../../images/batch-pred-job-def-edit-shared-
source.png)](../../../images/batch-pred-job-def-edit-shared-source.png)

In DataRobot, you cannot share connection credentials; therefore, you cannot
edit the destination settings—you must click **Reset connection** and use
_your_ credentials to configure a new **Destination type**.

[![](../../../images/batch-pred-job-def-edit-shared-
destination.png)](../../../images/batch-pred-job-def-edit-shared-
destination.png)

Note

As a deployment _Owner_ , you can edit any other information freely, and if
the **Prediction source** dataset is from the AI Catalog _and_ it is shared
with you, you can edit the existing connection directly.
